...
description: Export the trained Q-table to JSON, load it on the Pico, and run the complete MicroPython control loop that reads sensors, looks up the best action, and drives the motors.
layout: lesson
type: page
