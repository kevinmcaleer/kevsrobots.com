...
description: Discover why future rewards are worth less than immediate ones, and use discount factors and the Bellman equation to see the idea working in Python.
layout: lesson
type: page
