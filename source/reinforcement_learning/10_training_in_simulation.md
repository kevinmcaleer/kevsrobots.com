...
description: Build a complete grid-world simulator, train your Q-learning agent over hundreds of episodes, and watch the policy improve — all in plain Python.
layout: lesson
type: page
