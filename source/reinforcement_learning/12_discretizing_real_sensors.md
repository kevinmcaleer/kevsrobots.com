...
description: Read the HC-SR04 reliably in MicroPython, filter out noise with a median-of-three approach, and map live readings into the same state bins used during training.
layout: lesson
type: page
