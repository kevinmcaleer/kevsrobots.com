...
description: Train DQN on CartPole in ten lines using Stable-Baselines3 — your first neural-network RL agent — and understand how MlpPolicy replaces the Q-table.
layout: lesson
type: page
