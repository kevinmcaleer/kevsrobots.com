...
description: Port the BurgerBot GridWorld from the previous course into a proper Gymnasium environment, validate it with check_env, and run a random-agent rollout.
layout: lesson
type: page
