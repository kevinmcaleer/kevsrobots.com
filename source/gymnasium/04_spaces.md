...
description: Learn how Gymnasium's Discrete, Box, and MultiDiscrete spaces describe what an agent can observe and do — and why spaces make generic algorithms possible.
layout: lesson
type: page
