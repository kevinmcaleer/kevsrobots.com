...
date: 2025-11-20
previous: 03_control_flow.html
next: 05_pin_control.html
description: Learn how to define and use functions in MicroPython, including the shift
  away from Arduino's setup() and loop() pattern
percent: 40
duration: 8
navigation:
