...
next: 02_syntax_basics.html
description: Understand when to use MicroPython vs C++ for your microcontroller projects
  and make the right choice for your needs
percent: 16
duration: 7
navigation:
