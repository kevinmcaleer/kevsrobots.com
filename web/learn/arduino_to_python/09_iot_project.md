...
date: 2025-11-20
previous: 08_serial_basics.html
next: 10_robot_project.html
description: Build a complete IoT project that connects to WiFi, reads sensor data,
  and serves a web page showing real-time temperature readings
percent: 80
duration: 10
navigation:
