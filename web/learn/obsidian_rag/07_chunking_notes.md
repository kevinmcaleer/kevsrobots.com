...
date: 2026-08-23
previous: 06_parsing_notes.html
next: 08_building_the_index.html
description: Split notes into retrieval sized pieces along heading boundaries, and
  keep the context that makes each piece make sense
percent: 40
duration: 9
