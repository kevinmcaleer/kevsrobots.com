...
date: 2026-08-05
previous: 03_what_is_a_room_server.html
next: 05_room_server_config.html
description: Load room server firmware, set the UK radio settings, and confirm first
  boot
percent: 25
duration: 4
navigation:
