...
date: 2026-08-05
previous: 04_antennas_and_the_law.html
next: 06_radio_settings.html
description: Use the MeshCore web flasher to load repeater firmware on one board and
  companion firmware on the other
percent: 36
duration: 5
navigation:
