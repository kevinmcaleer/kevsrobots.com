...
next: 02_dataset_prep.html
description: Set up Jupyter Lab and create a Python virtual environment for training
  custom object detection models with PyTorch
percent: 22
duration: 5
navigation:
