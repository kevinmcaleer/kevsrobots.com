...
date: 2025-12-04
previous: 05_deployment.html
next: 07_troubleshooting.html
description: Build a real-time object detection application using your custom model
  and the Raspberry Pi AI Camera with live video feed
percent: 77
duration: 9
navigation:
