...
cover: /assets/img/blog/duckface/duckface.jpg
tags: 
 - Raspberry Pi
 - Bubo-2T
 - Python
...
`Duckface` is the name I've given to this project; its the precursor to the full Bubo robot suite of software I aim to create.
